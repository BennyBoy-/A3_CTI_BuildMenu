...
[_side, _headers, _classes, _prices, _times, _placements, _specials, _conditions] call compile preprocessFileLineNumbers "cti\Set_Structures.sqf";
...
[_side, _headers, _classes, _prices, _placements, _categories] call compile preprocessFileLineNumbers "cti\Set_Defenses.sqf";
